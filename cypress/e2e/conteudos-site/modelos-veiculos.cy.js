...
describe('Conteúdos - Modelos de Veículos', () => {
  ...
  it('Cadastrar Modelo de Veículo com sucesso', () => {
    cy.get(':nth-child(1) > .p-6 > a.w-full > [data-cy="control-panel-button"]').click()
    cy.get('[data-cy="Conteúdos-sidebar-button"]').click()
    cy.get(':nth-child(3) > .flex-wrap > :nth-child(6)').should('contain', 'Modelo de Veiculo').click()
